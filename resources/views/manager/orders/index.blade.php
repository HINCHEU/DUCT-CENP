...
<div class="container">
    ...
    <div class="odoo-search-wrapper">
        ...
        <div class="odoo-search-container">
            ...
            <form action="{{ route('manager.orders.index') }}" method="GET">
                @if(request('status')) <input type="hidden" name="status" value="{{ request('status') }}"> @endif
                @if(request('priority')) <input type="hidden" name="priority" value="{{ request('priority') }}"> @endif
                
                <input type="text" name="search" class="odoo-search-input" placeholder="Search order #, site, or engineer..." value="{{ request('search') }}">
        ...
        <div class="odoo-action-bar">
            <div class="odoo-action-left">
                <div class="odoo-dropdown">
                    <button type="button" class="odoo-dropdown-btn" onclick="toggleDropdown('filterDropdownManager')">
                    ...
                    <div id="filterDropdownManager" class="odoo-dropdown-menu">
