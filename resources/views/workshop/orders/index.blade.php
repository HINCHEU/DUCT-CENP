...
<div class="container">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 20px;">
        <h2 style="font-family:'Barlow Condensed', sans-serif; font-size:24px; color:#1B3F8B;">Workshop Queue</h2>
    </div>
    ...
    <div class="odoo-search-wrapper">
        ...
        <div class="odoo-search-container">
            ...
            <form action="{{ route('workshop.orders.index') }}" method="GET">
        ...
        <div class="odoo-action-bar">
            <div class="odoo-action-left">
                <div class="odoo-dropdown">
                    <button type="button" class="odoo-dropdown-btn" onclick="toggleDropdown('filterDropdownWorkshop')">
                    ...
                    <div id="filterDropdownWorkshop" class="odoo-dropdown-menu">
        ...
        <tbody>
            @forelse($orders as $order)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('workshop.orders.show', $order) }}" style="color:var(--accent); font-weight:500;">
                            View Details
                        </a>
                    </td>
                </tr>
